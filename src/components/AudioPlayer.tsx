    ...
    <div className={`bg-white rounded-lg shadow-md p-4 md:p-6 ${className}`}>
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h3 className="text-lg font-semibold text-[#101619]">
      ...
      <div className="flex items-center justify-between">
        ...
        {/* Playback Speed */}
        <div className="flex items-center space-x-2">
          <span className="text-sm text-[#577c8e]">{t('audio.speed')}:</span>
      ...
      <div className="mt-4 pt-4 border-t border-gray-200">
        <div className="flex items-center justify-between text-xs text-[#577c8e]">
          <span>
