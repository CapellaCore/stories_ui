        ...
        <div className="grid md:grid-cols-4 gap-8 mb-6">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/timetosleep_org" target="_blank" rel="noopener noreferrer" className="text-[#577c8e] hover:text-[#101619] transition-colors" aria-label="Instagram">
              ...
              <a href="https://www.pinterest.com/kdylkovat/" target="_blank" rel="noopener noreferrer" className="text-[#577c8e] hover:text-[#101619] transition-colors" aria-label="Pinterest">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://www.youtube.com/channel/UCGMoEK5MR5VNC7I3eDvK39Q" target="_blank" rel="noopener noreferrer" className="text-[#577c8e] hover:text-[#101619] transition-colors" aria-label="YouTube">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Legal */}
          <div>
            <h4 className="text-sm font-semibold text-[#101619] mb-3 uppercase tracking-wide">Legal</h4>
            <ul className="space-y-2">
              <li>
