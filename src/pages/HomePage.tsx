...
import StoriesByTagWrapper from '../components/StoriesByTagWrapper';
import StoriesListWrapper from "../components/StoriesListWrapper";
          ...
          <div className="w-full max-w-[960px] flex flex-col flex-1">
            <div className="flex flex-wrap justify-between gap-3 p-4">
              <div className="flex w-full md:min-w-72 flex-col gap-3">
                <p className="text-[#101619] tracking-tight text-xl md:text-2xl lg:text-[32px] font-bold leading-tight">
                  {t('home.welcomeTitle')}
                </p>
            ...
            {stories && stories.length > 0 ? (
                ...
                <p className="text-[#577c8e] text-lg md:text-xl lg:text-[22px] font-normal leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">
                  {t('home.noStoriesAvailable')}
                </p>
            )}

            <StoriesListWrapper stories={stories} showAll={false} maxVisible={3} />
          </div>
        </div>
      </>
  );
